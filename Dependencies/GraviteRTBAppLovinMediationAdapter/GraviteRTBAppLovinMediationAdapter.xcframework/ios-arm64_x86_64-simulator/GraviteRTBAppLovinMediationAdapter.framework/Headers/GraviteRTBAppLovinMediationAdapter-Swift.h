...
#ifndef GRAVITERTBAPPLOVINMEDIATIONADAPTER_SWIFT_H
#define GRAVITERTBAPPLOVINMEDIATIONADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GraviteRTBAppLovinMediationAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC34GraviteRTBAppLovinMediationAdapter23RTBAppLovinBannerLoader")
@interface RTBAppLovinBannerLoader : NSObject
- (nonnull instancetype)initWithBannerDelegate:(id <MAAdViewAdapterDelegate> _Nullable)bannerDelegate OBJC_DESIGNATED_INITIALIZER;
- (void)loadWithParameters:(id <MAAdapterResponseParameters> _Nonnull)parameters adFormat:(MAAdFormat * _Nonnull)adFormat;
- (void)destroy;
...
@interface RTBAppLovinBannerLoader (SWIFT_EXTENSION(GraviteRTBAppLovinMediationAdapter)) <RTBBannerViewDelegate>
...
SWIFT_CLASS("_TtC34GraviteRTBAppLovinMediationAdapter29RTBAppLovinInterstitialLoader")
@interface RTBAppLovinInterstitialLoader : NSObject
- (nonnull instancetype)initWithInterstitialDelegate:(id <MAInterstitialAdapterDelegate> _Nullable)interstitialDelegate OBJC_DESIGNATED_INITIALIZER;
...
@interface RTBAppLovinInterstitialLoader (SWIFT_EXTENSION(GraviteRTBAppLovinMediationAdapter)) <RTBFullscreenDelegate>
...
@protocol MAAdapterParameters;

SWIFT_CLASS("_TtC34GraviteRTBAppLovinMediationAdapter18RTBAppLovinManager")
@interface RTBAppLovinManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) RTBAppLovinManager * _Nonnull shared;)
+ (RTBAppLovinManager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (BOOL)initializeWith:(id <MAAdapterInitializationParameters> _Nonnull)parameters SWIFT_WARN_UNUSED_RESULT;
- (void)prepareItunesIdWithParameters:(id <MAAdapterParameters> _Nonnull)parameters;
