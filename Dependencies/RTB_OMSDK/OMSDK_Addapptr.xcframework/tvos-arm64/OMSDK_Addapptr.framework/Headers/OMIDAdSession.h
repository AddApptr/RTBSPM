 ...
 */
@interface OMIDAddapptrAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDAddapptrAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDAddapptrAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDAddapptrAdSessionContext *)context
